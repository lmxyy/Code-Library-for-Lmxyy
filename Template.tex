...
\section{Counting Integral Point under Straight Line}
\cppcode{/Numerical Algorithms/Counting Integral Point under Straight Line.cpp}
...
\cppcode{/String Algorihtms/Aho-Corasick Automaton.cpp}
\section{Knuth-Morris-Pratt Algorithm}
\cppcode{/String Algorihtms/Knuth-Morris-Pratt Algorithm.cpp}
\section{Manacher Algorithm}
\cppcode{/String Algorihtms/Manacher Algorithm.cpp}
\section{Palindrome Automaton}
\cppcode{/String Algorihtms/Palindrome Automaton.cpp}
\section{Suffix Array}
\cppcode{/String Algorihtms/Suffix Array.cpp}
\section{Suffix Automaton}
\cppcode{/String Algorihtms/Suffix Automaton.cpp}

\chapter{Others}
\section{Calculate Date}
\cppcode{/Others/Calculate Date.cpp}
\section{Java Hints}
